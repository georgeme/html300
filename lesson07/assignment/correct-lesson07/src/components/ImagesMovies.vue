  ...
  <div>
    ...
    <div>
      <b-container>
        <b-row>
          <b-col>1 of 3
            <b-img v-for="item in knowItems" fluid :key="item.id" :src="item.image" :alt="item.alt">
            </b-img>
          </b-col>
          <b-row>
      </b-container>
...
Stars we love images
    <div>
      <b-container>
        <b-row>
          <b-col>1 of 3
            <b-img v-for="item in loveItems" fluid :key="item.id" :src="item.image" :alt="item.alt">
            </b-img>
          </b-col>
        <b-row>
      </b-container>
